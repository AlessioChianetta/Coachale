...
function startAudioStream(conn: any, uuid: string, tStart: number): void {
  (conn as any).bgapi(`uuid_setvar_multi ${uuid} STREAM_PLAYBACK=true;STREAM_SAMPLE_RATE=8000;mod_audio_stream_bidirectional=true;jitterbuffer_msec=120:200:60`);
