...
const ConsultantLeadDetail = lazy(() => import("@/pages/consultant-lead-detail"));
    ...
    <>
      <Suspense fallback={<PageTransition />}>
        <Switch>
          ...
          <Route path="/consultant/lead-scraper/lead/:leadId">
            <AuthGuard requiredRole="consultant">
          ...
          <Route path="/consultant/ai-autonomy/employee/:roleId">
            <AuthGuard requiredRole="consultant">
              <EmployeeProfilePage />
            </AuthGuard>
          </Route>
          ...
          <Route path="/consultant/guide-social-flows">
            <AuthGuard requiredRole="consultant">
              <GuideSocialFlows />
            </AuthGuard>
          </Route>
