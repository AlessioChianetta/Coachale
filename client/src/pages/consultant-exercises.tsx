    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20">
      ...
      <div className={`flex ${isMobile ? 'h-[calc(100vh-80px)]' : 'h-screen'}`}>
        ...
        <main className="flex-1 p-4 md:p-6 lg:p-8">
          <div className="max-w-7xl mx-auto space-y-6 md:space-8">
            {/* Header */}
                            ...
                            >
                              <div className="flex items-center gap-3 w-full">
                                <div className={`w-8 h-8 rounded-lg flex items-center justify-center ${
                                  selectedCategory === 'all' ? 'bg-white/20' : 'bg-gradient-to-r from-blue-500 to-purple-600'
                                }`}>
                            ...
                            {['post-consulenza', 'metodo-turbo', 'metodo-hybrid', 'newsletter', 'finanza-personale', 'vendita', 'marketing', 'imprenditoria', 'risparmio-investimenti', 'contabilità', 'gestione-risorse', 'strategia'].map((category) => {
                              ...
                              return (
                                ...
                                >
                                  <div className="flex items-center gap-3 w-full">
                                    <div className={`w-8 h-8 rounded-lg flex items-center justify-center ${
                                      selectedCategory === category ? 'bg-white/20' : 'bg-muted'
                                    }`}>
