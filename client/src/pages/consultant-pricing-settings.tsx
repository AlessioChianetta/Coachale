...
const defaultFormData: FormData = {
  ...
  level1Name: "Bronze",
  level1Description: "",
  level1DailyMessageLimit: 5,
  level1Features: [],
  level2Name: "Silver",
  level2Description: "",
  level2ShortDescription: "",
  level2MonthlyPriceEuros: "",
  level2YearlyPriceEuros: "",
  level2Features: [],
  level2Badge: "",
  level2CtaText: "Inizia Ora",
  level3Name: "Gold",
  level3Description: "",
  level3ShortDescription: "",
  level3MonthlyPriceEuros: "",
  level3YearlyPriceEuros: "",
  level3Features: [],
  level3Badge: "Più Popolare",
  ...
  useEffect(() => {
    if (pricingData) {
      ...
      setFormData({
        ...
        level1Description: config.level1Description || "",
        level1DailyMessageLimit: config.level1DailyMessageLimit || 5,
        level1Features: config.level1Features || [],
        level2Name: config.level2Name || "Silver",
        level2Description: config.level2Description || "",
        level2ShortDescription: config.level2ShortDescription || "",
        level2MonthlyPriceEuros: centsToEuros(config.level2MonthlyPriceCents || config.level2PriceCents),
        level2YearlyPriceEuros: centsToEuros(config.level2YearlyPriceCents),
        level2Features: config.level2Features || [],
        level2Badge: config.level2Badge || "",
        level2CtaText: config.level2CtaText || "Inizia Ora",
        level3Name: config.level3Name || "Gold",
        level3Description: config.level3Description || "",
        level3ShortDescription: config.level3ShortDescription || "",
        level3MonthlyPriceEuros: centsToEuros(config.level3MonthlyPriceCents || config.level3PriceCents),
        level3YearlyPriceEuros: centsToEuros(config.level3YearlyPriceCents),
        level3Features: config.level3Features || [],
        level3Badge: config.level3Badge || "Più Popolare",
        level3CtaText: config.level3CtaText || "Inizia Ora",
        ...
        guaranteeText: config.guaranteeText || "",
