    ...
    <div className="relative flex flex-col items-center justify-center min-h-screen bg-slate-50 dark:bg-[hsl(222,18%,6%)] overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        {[...Array(6)].map((_, i) => (
          <div
            key={i}
            className="absolute rounded-full bg-cyan-500/10 dark:bg-cyan-400/5"
            style={{
              width: `${4 + i * 2}px`,
              height: `${4 + i * 2}px`,
              left: `${15 + i * 14}%`,
      ...
      <div className="relative z-10 flex flex-col items-center">
        <div className="relative flex items-center justify-center">
          ...
          />
          <div className="absolute w-20 h-20 rounded-full border border-cyan-500/10 dark:border-cyan-400/5 animate-ping" style={{ animationDuration: '2.5s' }} />
          <div
            className="relative p-4 bg-gradient-to-br from-cyan-500 to-teal-500 rounded-2xl shadow-2xl shadow-cyan-500/25 dark:shadow-cyan-500/15"
