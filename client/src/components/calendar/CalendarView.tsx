...
export default function CalendarView({ calendarEmail: propCalendarEmail }: CalendarViewProps) {
  ...
  const calendarEmail = propCalendarEmail || settings?.googleCalendarEmail;
