...
import { Target, CheckSquare, MessageSquare, Plus, Trash2 } from 'lucide-react';
...
export function BlockEditor({ structure, selectedBlock, onSelectBlock, onAddBlock, onDeleteBlock, isEditing }: BlockEditorProps) {
