...
const consultantCategories: SidebarCategoryExtended[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Template", href: "/consultant/guide-templates", icon: FileText, color: "text-blue-500" },
      { name: "Lead", href: "/consultant/guide-leads", icon: UserPlus, color: "text-emerald-500" },
      { name: "Setup Agenti", href: "/consultant/guide-agents", icon: Bot, color: "text-gray-500" },
      { name: "API Keys", href: "/consultant/guide-api-keys", icon: Key, color: "text-purple-500" },
