...
- Momentum-Style Weekly Calendar for AI Tasks: Interactive hourly grid (8:00-20:00) with 7-day columns. Click on empty slots to pre-fill task form with selected date/time. AI Tasks shown in purple, scheduled calls in blue. Red line indicator for current time. Scroll-to-form on slot click with toast confirmation.
