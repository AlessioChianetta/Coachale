...
export const COURSE_THEMES: CourseTheme[] = [
  {
    ...
    styles: {
      ...
      keyPointsBox: 'bg-blue-50 dark:bg-blue-950/30 border-l-4 border-blue-600 rounded-r-lg p-5 my-6',
      keyPointsTitle: 'text-lg font-bold text-blue-900 dark:text-blue-100 mb-3 flex items-center gap-2',
      keyPointsItem: 'text-blue-800 dark:text-blue-200 mb-2 flex items-start gap-2',
      exampleBox: 'bg-slate-100 dark:bg-slate-800/50 border border-slate-300 dark:border-slate-600 rounded-xl p-5 my-6',
      exampleTitle: 'text-lg font-semibold text-slate-800 dark:text-slate-200 mb-3 flex items-center gap-2',
      exampleContent: 'text-slate-700 dark:text-slate-300',
      noteBox: 'bg-amber-50 dark:bg-amber-950/30 border border-amber-300 dark:border-amber-700 rounded-lg p-4 my-5',
      noteTitle: 'text-amber-800 dark:text-amber-200 font-semibold mb-2 flex items-center gap-2',
      noteContent: 'text-amber-700 dark:text-amber-300',
      actionBox: 'bg-green-50 dark:bg-green-950/30 border-2 border-green-500 rounded-xl p-5 my-6',
      actionTitle: 'text-lg font-bold text-green-800 dark:text-green-200 mb-3 flex items-center gap-2',
      actionItem: 'text-green-700 dark:text-green-300 mb-2 pl-6 relative before:content-["✓"] before:absolute before:left-0 before:text-green-600',
      summaryBox: 'bg-gradient-to-r from-blue-100 to-indigo-100 dark:from-blue-950/40 dark:to-indigo-950/40 border border-blue-300 dark:border-blue-700 rounded-2xl p-6 my-8',
  ...
  },
  {
    ...
    styles: {
      ...
      keyPointsBox: 'bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-950/30 dark:to-teal-950/30 rounded-2xl p-6 my-6 shadow-sm',
      keyPointsTitle: 'text-lg font-semibold text-emerald-800 dark:text-emerald-200 mb-3 flex items-center gap-2',
      keyPointsItem: 'text-emerald-700 dark:text-emerald-300 mb-2 flex items-start gap-2',
      exampleBox: 'bg-purple-50 dark:bg-purple-950/30 rounded-2xl p-5 my-6 border border-purple-200 dark:border-purple-800',
      exampleTitle: 'text-lg font-semibold text-purple-800 dark:text-purple-200 mb-3 flex items-center gap-2',
      exampleContent: 'text-purple-700 dark:text-purple-300',
      noteBox: 'bg-rose-50 dark:bg-rose-950/30 rounded-xl p-4 my-5 border border-rose-200 dark:border-rose-800',
      noteTitle: 'text-rose-700 dark:text-rose-300 font-medium mb-2 flex items-center gap-2',
      noteContent: 'text-rose-600 dark:text-rose-400',
      actionBox: 'bg-gradient-to-r from-green-100 to-emerald-100 dark:from-green-950/40 dark:to-emerald-950/40 rounded-2xl p-6 my-6',
      actionTitle: 'text-lg font-semibold text-green-800 dark:text-green-200 mb-3 flex items-center gap-2',
      actionItem: 'text-green-700 dark:text-green-300 mb-3 pl-6 relative before:content-["🌱"] before:absolute before:left-0',
      summaryBox: 'bg-gradient-to-br from-teal-100 via-emerald-100 to-green-100 dark:from-teal-950/40 dark:via-emerald-950/40 dark:to-green-950/40 rounded-3xl p-8 my-8 shadow-lg',
  ...
  },
  {
    ...
    styles: {
      ...
      paragraph: 'text-gray-700 dark:text-gray-300 mb-4 leading-7',
      keyPointsBox: 'bg-gradient-to-r from-orange-100 to-yellow-100 dark:from-orange-950/40 dark:to-yellow-950/40 rounded-xl p-5 my-6 border-2 border-orange-300 dark:border-orange-700',
      keyPointsTitle: 'text-lg font-bold text-orange-700 dark:text-orange-300 mb-3 flex items-center gap-2',
      keyPointsItem: 'text-orange-800 dark:text-orange-200 mb-2 flex items-start gap-2',
      exampleBox: 'bg-pink-50 dark:bg-pink-950/30 rounded-xl p-5 my-6 border border-pink-300 dark:border-pink-700',
      exampleTitle: 'text-lg font-bold text-pink-700 dark:text-pink-300 mb-3 flex items-center gap-2',
      exampleContent: 'text-pink-600 dark:text-pink-400',
      noteBox: 'bg-yellow-100 dark:bg-yellow-950/40 rounded-lg p-4 my-5 border-l-4 border-yellow-500',
      noteTitle: 'text-yellow-800 dark:text-yellow-200 font-bold mb-2 flex items-center gap-2',
      noteContent: 'text-yellow-700 dark:text-yellow-300',
      actionBox: 'bg-gradient-to-br from-red-100 to-orange-100 dark:from-red-950/40 dark:to-orange-950/40 rounded-2xl p-6 my-6 border-2 border-red-400 dark:border-red-600',
      actionTitle: 'text-lg font-bold text-red-700 dark:text-red-300 mb-3 flex items-center gap-2',
      actionItem: 'text-red-600 dark:text-red-400 mb-2 pl-6 relative before:content-["🔥"] before:absolute before:left-0',
      summaryBox: 'bg-gradient-to-r from-orange-200 via-pink-200 to-purple-200 dark:from-orange-950/50 dark:via-pink-950/50 dark:to-purple-950/50 rounded-2xl p-6 my-8 shadow-xl',
  ...
  },
  {
    ...
    styles: {
      ...
      keyPointsBox: 'bg-gray-900 dark:bg-gray-950 text-green-400 rounded-lg p-5 my-6 border border-gray-700 font-mono',
      keyPointsTitle: 'text-lg font-bold text-green-300 mb-3 flex items-center gap-2',
      keyPointsItem: 'text-green-400 mb-2 flex items-start gap-2 before:content-[">"] before:text-green-500',
      exampleBox: 'bg-slate-800 dark:bg-slate-900 rounded-lg p-5 my-6 border border-slate-600',
      exampleTitle: 'text-lg font-semibold text-cyan-400 mb-3 flex items-center gap-2',
      exampleContent: 'text-slate-300 font-mono text-sm',
      noteBox: 'bg-yellow-950/50 border border-yellow-700 rounded-lg p-4 my-5',
      noteTitle: 'text-yellow-400 font-semibold mb-2 flex items-center gap-2',
      noteContent: 'text-yellow-300 font-sans',
      actionBox: 'bg-teal-950 border-2 border-teal-500 rounded-lg p-5 my-6',
      actionTitle: 'text-lg font-bold text-teal-300 mb-3 flex items-center gap-2',
      actionItem: 'text-teal-200 mb-2 pl-6 relative before:content-["$"] before:absolute before:left-0 before:text-teal-500 font-mono',
      summaryBox: 'bg-gradient-to-r from-gray-800 to-slate-800 dark:from-gray-900 dark:to-slate-900 rounded-xl p-6 my-8 border border-teal-600',
  ...
  },
  {
    ...
    styles: {
      ...
      keyPointsBox: 'bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg p-5 my-6',
      keyPointsTitle: 'text-lg font-bold text-gray-800 dark:text-gray-200 mb-3 flex items-center gap-2',
      keyPointsItem: 'text-gray-700 dark:text-gray-300 mb-2 flex items-start gap-2',
      exampleBox: 'bg-stone-100 dark:bg-stone-800/50 rounded-lg p-5 my-6 border border-stone-300 dark:border-stone-600',
      exampleTitle: 'text-lg font-semibold text-stone-700 dark:text-stone-300 mb-3 flex items-center gap-2',
      exampleContent: 'text-stone-600 dark:text-stone-400',
      noteBox: 'bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800 rounded-lg p-4 my-5',
      noteTitle: 'text-blue-700 dark:text-blue-300 font-semibold mb-2 flex items-center gap-2',
      noteContent: 'text-blue-600 dark:text-blue-400',
      actionBox: 'bg-green-50 dark:bg-green-950/30 border border-green-300 dark:border-green-700 rounded-lg p-5 my-6',
      actionTitle: 'text-lg font-semibold text-green-800 dark:text-green-200 mb-3 flex items-center gap-2',
      actionItem: 'text-green-700 dark:text-green-300 mb-2 pl-6 relative before:content-["•"] before:absolute before:left-2 before:text-green-600',
      summaryBox: 'bg-gray-50 dark:bg-gray-900 border-2 border-gray-300 dark:border-gray-600 rounded-lg p-6 my-8',
...
<h2 class="${theme.styles.sectionTitle}">${theme.icons.bullet} Titolo Sezione</h2>
