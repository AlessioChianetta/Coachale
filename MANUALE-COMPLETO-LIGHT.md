...
**Dove trovarlo:** `Sidebar → PRINCIPALE → Setup Iniziale`
...
**Clienti CRM** — Contatti commerciali senza accesso alla piattaforma.
...
**Dove:** `Sidebar → COMUNICAZIONE → HUB Lead → Campagne` (o `/consultant/campaigns`)
...
**Dove:** `Sidebar → LAVORO QUOTIDIANO → Task`
...
- **Documenti KB** — Gestione documenti della Knowledge Base
- **WhatsApp** — Gestione agenti e conversazioni WhatsApp
- **Lead Scraper** — Ricerca lead su Google Maps/Search e CRM
- **Chiamate** — Monitoraggio e gestione chiamate vocali AI

Tutte queste sezioni rimangono accessibili anche dalle loro URL dirette.
...
### 22.3 Interfaccia Utente – Le 8 Schede
...
**Dove trovarlo:** Sidebar → COMUNICAZIONE → AI Autonomo → Tab Chiamate
...
**Dove trovarlo:** Sidebar → COMUNICAZIONE → AI Autonomo → Tab Chiamate → Centralino
