...
-- Inserimento Template "Metodo Orbitale - Da 0 a 1.000.000"
DO $$
DECLARE
    template_id_var VARCHAR;
    trimester_1_id VARCHAR;
    trimester_2_id VARCHAR;
    trimester_3_id VARCHAR;
    trimester_4_id VARCHAR;
    trimester_5_id VARCHAR;
    module_1_id VARCHAR;
    module_2_id VARCHAR;
    module_3_id VARCHAR;
    module_4_id VARCHAR;
...
BEGIN
    ...
    VALUES (
        'Metodo Orbitale - Da 0 a 1.000.000',
        'Il tuo percorso per diventare libero finanziariamente - 53 lezioni in 5 categorie',
        true,
        (SELECT id FROM users WHERE role = 'consultant' LIMIT 1)
    )
    RETURNING id INTO template_id_var;

    -- 2. Crea i 5 Trimestri (PARTE 1-5)
    INSERT INTO template_trimesters (template_id, title, description, sort_order)
    VALUES (
        template_id_var,
        'PARTE 1: LE FONDAMENTA',
        'Il mindset del denaro e la fotografia della tua situazione attuale - 9 lezioni',
        1
    )
    RETURNING id INTO trimester_1_id;

    INSERT INTO template_trimesters (template_id, title, description, sort_order)
    VALUES (
        template_id_var,
        'PARTE 2: LA COSTRUZIONE DELLA RICCHEZZA',
        'Costruiamo ricchezza per sempre - 7 lezioni',
        2
    )
    RETURNING id INTO trimester_2_id;

    INSERT INTO template_trimesters (template_id, title, description, sort_order)
    VALUES (
        template_id_var,
        'PARTE 3: OTTIMIZZAZIONE E PSICOLOGIA',
        'Progettiamo e ottimizziamo - 8 lezioni',
        3
    )
    RETURNING id INTO trimester_3_id;

    INSERT INTO template_trimesters (template_id, title, description, sort_order)
    VALUES (
        template_id_var,
        'PARTE 4: LA VITA DA COMANDANTE',
        'Comanda le tue finanze - 9 lezioni',
        4
    )
    RETURNING id INTO trimester_4_id;

    INSERT INTO template_trimesters (template_id, title, description, sort_order)
    VALUES (
        template_id_var,
        'PARTE 5: EREDITÀ E COMANDO PERPETUO',
        'Navighiamo nella tua futura eredità - 20 lezioni',
        5
    )
    RETURNING id INTO trimester_5_id;
    ...
    VALUES (
        trimester_2_id,
        'Modulo 2: LA COSTRUZIONE DELLA RICCHEZZA',
    ...
    VALUES (
        trimester_3_id,
        'Modulo 3: OTTIMIZZAZIONE E PSICOLOGIA',
        'Progettiamo e ottimizziamo',
        1
    )
    ...
    VALUES (
        trimester_4_id,
        'Modulo 4: LA VITA DA COMANDANTE',
        'Comanda le tue finanze',
        1
    )
    ...
    VALUES (
        trimester_5_id,
        'Modulo 5: EREDITÀ E COMANDO PERPETUO',
        'Navighiamo nella tua futura eredità',
        1
    )
    RETURNING id INTO module_5_id;

    -- 4. PARTE 1: LE FONDAMENTA (9 lezioni)
    INSERT INTO template_lessons (template_module_id, title, description, sort_order, library_document_id)
    VALUES 
    (module_1_id, 'Capitolo 0 Introduzione, COMANDA LE TUE FINANZE', 'Aiuto imprenditori, liberi professionisti e dipendenti a creare, gestire e proteggere il proprio denaro', 1,
    ...
    (module_1_id, 'Capitolo 1: La Causa - Il Tuo "Perché" Strategico', 'Trova la tua stella polare finanziaria!', 2,
        (SELECT id FROM library_documents WHERE title = 'Capitolo 1: La Causa - Il Tuo "Perché" Strategico' AND is_published = true LIMIT 1)),
    
    (module_1_id, 'Capitolo 2: La Mappa del Tesoro - Diagnosi del Tuo Patrimonio Netto', 'La Verità dei Numeri: Misura la Tua Ricchezza Reale', 3,
    ...
    (module_1_id, 'Capitolo 3: Intelligence Finanziaria - Padroneggiare i Flussi di Cassa', 'Segui i Soldi: Diventa l''Agente Segreto delle Tue Finanze', 4,
    ...
    (module_1_id, 'Capitolo 4: Il Piano di Comando - Dall''Anarchia al Controllo', 'Prendi il Timone: Assegna una Missione a Ogni Euro', 5,
    ...
    (module_1_id, 'Capitolo 5: Le Catene Invisibili - Dichiarazione di Guerra al Debito Tossico', 'Libera il Tuo Futuro: Annienta i Debiti Nocivi', 6,
    ...
    (module_1_id, 'Capitolo 6: Lo Scudo Infrangibile - Costruire la Tua Riserva d''Emergenza', 'La Fortezza Anti-Imprevisti: Il Tuo Airbag Finanziario', 7,
    ...
    (module_1_id, 'Capitolo 7: Il Fossato della Fortezza - Un Uso Strategico delle Assicurazioni', 'Proteggi il Regno: Assicurati Solo per le Catastrofi', 8,
    ...
    (module_1_id, 'Capitolo 8: Il Tuo Asset Invisibile - Padroneggiare il Merito Creditizio', 'La Tua Reputazione Finanziaria: La Chiave d''Oro per le Opportunità', 9,
    ...
    -- 5. PARTE 2: LA COSTRUZIONE DELLA RICCHEZZA (7 lezioni)
    INSERT INTO template_lessons (template_module_id, title, description, sort_order, library_document_id)
    VALUES 
    (module_2_id, 'Capitolo 9: Le Forze Gemelle - Interesse Composto e Inflazione', 'Il Creatore e il Distruttore: Comprendi le Leggi del Tempo', 1,
    ...
    (module_2_id, 'Capitolo 10: L''Identità dell''Investitore - Strategia, Rischio e Azzardo', 'Chi Sei nel Gioco dei Soldi? Scegli la Tua Strategia', 2,
    ...
    (module_2_id, 'Capitolo 11: I Mattoni della Ricchezza - Azioni e Obbligazioni', 'Il Motore e i Freni: Costruisci il Tuo Portafoglio', 3,
    ...
    (module_2_id, 'Capitolo 12: L''Unico Pranzo Gratis della Finanza - La Magia della Diversificazione', 'Non Mettere Tutte le Uova Nello Stesso Paniere (e Perché)', 4,
    ...
    (module_2_id, 'Capitolo 13: Lo Strumento Definitivo - Gli ETF e la Rivoluzione Passiva', 'Il Tuo Passaporto per il Mercato Globale (a Basso Costo)', 5,
    ...
    (module_2_id, 'Capitolo 14: Il Tuo Negozio di Investimenti - Scegliere il Broker Giusto (e Non Farsi Fregare)', 'Apri la Tua "Ferramenta" Finanziaria: La Guida alla Scelta', 6,
    ...
    (module_2_id, 'Capitolo 15: Il Pilota Automatico per Investire - La Superiorità Strategica del Piano di Accumulo (PAC)', 'Metti il Turbo alla Disciplina: Investi Senza Pensarci', 7,
    ...
    -- 6. PARTE 3: OTTIMIZZAZIONE E PSICOLOGIA (8 lezioni)
    INSERT INTO template_lessons (template_module_id, title, description, sort_order, library_document_id)
    VALUES 
    (module_3_id, 'Capitolo 16: La Macchina del Tempo Finanziaria - Progettare la Tua Pensione', 'Parla con il Tuo Io Futuro: Costruisci Oggi la Tua Serenità', 1,
    ...
    (module_3_id, 'Capitolo 17: La Guerra nella Tua Mente - Sconfiggere i Nemici Psicologici dell''Investitore', 'Il Tuo Peggior Nemico Sei Tu: Domina le Tue Emozioni', 2,
    ...
    (module_3_id, 'Capitolo 18: La Verità sul Mattone - L''Investimento Immobiliare tra Mito e Realtà', 'Il Sogno Italiano Sotto la Lente: Pro e Contro dell''Immobiliare', 3,
    ...
    (module_3_id, 'Capitolo 19: Il Tuo Socio Silenzioso - Capire le Tasse sugli Investimenti (senza mal di testa)', 'Non Aver Paura del Fisco: Conosci le Regole del Gioco', 4,
    ...
    (module_3_id, 'Capitolo 20: L''Arte dell''Efficienza - Strategie Fiscali per Massimizzare i Rendimenti Netti', 'Metti il Turbo ai Guadagni: Paga le Tasse in Modo Intelligente', 5,
    ...
    (module_3_id, 'Capitolo 21: Il Tuo Asset da un Milione di Euro - Massimizzare la Carriera', 'Il Tuo Lavoro è Oro: Trasformalo in un Motore di Ricchezza', 6,
    ...
    (module_3_id, 'Capitolo 22: La Diversificazione del Reddito - Creare la Tua Prima Entrata Extra (Side Hustle)', 'Non Dipendere da un Solo Padrone: Costruisci la Tua Rete di Sicurezza', 7,
    ...
    (module_3_id, 'Capitolo 23: Il Salto Quantico - Da Side Hustle a Vero Business', 'Fai Crescere la Tua Creatura: Struttura e Scala la Tua Attività', 8,
    ...
    -- 7. PARTE 4: LA VITA DA COMANDANTE (9 lezioni)
    INSERT INTO template_lessons (template_module_id, title, description, sort_order, library_document_id)
    VALUES 
    (module_4_id, 'Capitolo 24: Il Denaro nelle Relazioni - Costruire un Impero di Squadra', 'Finanza a Due: Trasforma il Partner nel Tuo Migliore Alleato', 1,
    ...
    (module_4_id, 'Capitolo 25: L''Eredità più Grande - Educazione Finanziaria per i Figli', 'Non Solo Soldi, Ma Saggezza: Prepara i Tuoi Figli al Futuro', 2,
    ...
    (module_4_id, 'Capitolo 26: La Filosofia F.I.R.E. - Ingegneria Inversa della Libertà', 'Accelera Verso la Libertà: Compra il Tuo Tempo, Non Solo Cose', 3,
    ...
    (module_4_id, 'Capitolo 27: Il Numero della Libertà - Calcolare il Tuo Traguardo per l''Indipendenza Finanziaria', 'Quanto Costa la Tua Libertà? Dai un Numero al Tuo Sogno', 4,
    ...
    (module_4_id, 'Capitolo 28: Manuale di Sopravvivenza per l''Inverno Finanziario (Come Affrontare un Mercato al Ribasso)', 'Tempesta in Arrivo? Resta al Timone e Non Mollare', 5,
    ...
    (module_4_id, 'Capitolo 29: La Trappola dell''Euforia - Gestire un Mercato al Rialzo (e Non Diventare il Tuo Peggior Nemico)', 'Sole Splendente? Non Farti Accecare dall''Arroganza', 6,
    ...
    (module_4_id, 'Capitolo 30: La Manutenzione della Macchina - Rivedere e Ribilanciare il Tuo Portafoglio', 'Il Tagliando del Tuo Motore: Mantieni l''Equilibrio Perfetto', 7,
    ...
    (module_4_id, 'Capitolo 31: La Variabile Dominante - Padroneggiare l''Orizzonte Temporale', 'Il Tempo è il Capitano: Scegli la Rotta Giusta per Ogni Viaggio', 8,
    ...
    (module_4_id, 'Capitolo 32: L''Ultima Frontiera - Usare i Soldi per Comprare la Felicità (Sì, è Possibile)', 'Il Vero Scopo dei Soldi: Investi nella Tua Gioia di Vivere', 9,
    ...
    -- 8. PARTE 5: EREDITÀ E COMANDO PERPETUO (20 lezioni)
    INSERT INTO template_lessons (template_module_id, title, description, sort_order, library_document_id)
    VALUES 
    (module_5_id, 'Capitolo 33: La Tua Costituzione Personale - Creare il Tuo Manifesto Finanziario', 'Nero su Bianco: Incidi i Tuoi Principi Guida Inattaccabili', 1,
    ...
    (module_5_id, 'Capitolo 34: L''Eredità del Comando - Pianificazione Successoria e Responsabilità', 'Proteggi Chi Ami: Prendi il Controllo Anche del "Dopo"', 2,
    ...
    (module_5_id, 'Capitolo 35: Il Cerchio si Chiude - La Ricchezza che si Ottiene Donando', 'Abbondanza Chiama Abbondanza: Il Potere Strategico della Generosità', 3,
    ...
    (module_5_id, 'Capitolo 36: La Dieta dell''Informazione - Navigare le Notizie Finanziarie Senza Impazzire', 'Spegni il Rumore, Accendi il Cervello: Filtra le Notizie Inutili', 4,
    ...
    (module_5_id, 'Capitolo 37: Affilare la Lama - L''Impegno per una Formazione Finanziaria Continua', 'Il Tuo Allenamento Non Finisce Mai: Resta Curioso, Resta Competente', 5,
    ...
    (module_5_id, 'Capitolo 38: Il GPS per la Vita - Assemblare il Tuo Piano Finanziario Completo', 'La Mappa Definitiva: Metti Tutti i Pezzi Insieme', 6,
    ...
    (module_5_id, 'Capitolo 39: L''Arte della Celebrazione e il Ritmo del Successo', 'Pausa e Applausi: Ricarica le Batterie per la Lunga Corsa', 7,
    ...
    (module_5_id, 'Capitolo 40: La Fine dell''Inizio - Trasformare Questo percorso in una Vita di Ricchezza', 'Hai Imparato a Pilotare: Ora Inizia il Tuo Viaggio Infinito', 8,
    ...
    (module_5_id, 'Capitolo 41: Oltre il Numero - La Vita Dopo l''Indipendenza Finanziaria', 'La Vetta è Raggiunta, e Adesso? Progetta la Tua Libertà', 9,
    ...
    (module_5_id, 'Capitolo 42: La Fase di Decumulo - Come Prelevare dal Tuo Portafoglio in Modo Intelligente', 'Vivere di Rendita: Strategie per Far Durare il Tuo Tesoro', 10,
    ...
    (module_5_id, 'Capitolo 43: L''Arte del Lavoro Opzionale - Ridefinire il Successo e lo Scopo', 'Lavorare per Scelta, Non per Forza: Trova il Tuo Nuovo Significato', 11,
    ...
    (module_5_id, 'Capitolo 44: Il Patrimonio Olistico - Investire in Salute, Relazioni e Conoscenza', 'La Vera Ricchezza Non è Solo Denaro: Coltiva Ogni Tuo Capitale', 12,
    ...
    (module_5_id, 'Capitolo 45: Resilienza a Lungo Termine - Adattare il Piano ai Grandi Cambiamenti della Vita', 'La Vita Accade: Ricalibra la Rotta Senza Perdere la Bussola', 13,
    ...
    (module_5_id, 'Capitolo 46: Costruire una "Dinastia" - La Gestione Patrimoniale Intergenerazionale', 'Oltre Te Stesso: Lascia un''Eredità Che Duri nel Tempo', 14,
    ...
    (module_5_id, 'Capitolo 47: Il Viaggio Infinito - La Tua Eredità di Saggezza', 'La Fine è Solo l''Inizio: Continua a Imparare, Continua a Crescere', 15,
    ...
    (module_5_id, 'Capitolo 48: Glossario Strategico - Il Tuo Dizionario per il Comando Finanziario', 'Parla la Lingua del Successo: I Termini Chiave a Portata di Mano', 16,
    ...
    (module_5_id, 'Capitolo 49: Il Comando è Tuo', 'Hai la Mappa, Hai la Bussola: Prendi il Timone del Tuo Destino', 17,
        (SELECT id FROM library_documents WHERE title = 'Capitolo 49: Il Comando è Tuo' AND is_published = true LIMIT 1)),
    
    (module_5_id, 'Capitolo 50: Il Progetto Definitivo - Creare il Tuo Piano Finanziario Completo (Il Tuo GPS per la Vita)', 'Di Nuovo la Mappa Definitiva: Metti Tutti i Pezzi Insieme (Ripasso Cap. 38)', 18,
    ...
    (module_5_id, 'Capitolo 51: L''Arte della Celebrazione - Il Ritmo Sostenibile del Successo', 'Di Nuovo Pausa e Applausi: Ricarica le Batterie (Ripasso Cap. 39)', 19,
    ...
    (module_5_id, 'Capitolo 52: La Fine dell''Inizio - Il Tuo Comando Perpetuo', 'Il Volo è Appena Cominciato: Guida la Tua Macchina Verso il Futuro', 20,
    ...
    RAISE NOTICE 'Template "Metodo Orbitale - Da 0 a 1.000.000" creato con successo!';
    RAISE NOTICE 'Template ID: %', template_id_var;
    RAISE NOTICE 'Totale lezioni: 53 (9+7+8+9+20)';
...
WHERE ut.name LIKE '%Metodo Orbitale%'
