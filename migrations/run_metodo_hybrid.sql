...
-- Esegui questo script con: psql -h <host> -U <user> -d <database> -f migrations/run_metodo_hybrid.sql
-- Oppure collegati con psql e copia-incolla questo contenuto
...
BEGIN
  ...
  RAISE NOTICE 'Template "Anno 1 – Metodo Hybrid" creato con successo!';
  RAISE NOTICE 'Template ID: %', template_id;
  RAISE NOTICE 'Totale: 2 Trimestri, 9 Moduli, 32 Lezioni';
