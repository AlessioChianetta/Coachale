...
import { buildSalesAgentPrompt, buildStaticSalesAgentPrompt, buildSalesAgentDynamicContext, buildMinimalSalesAgentInstruction, buildFullSalesAgentContext } from './sales-agent-prompt-builder';
  ...
  wss.on('connection', async (clientWs, req) => {
    ...
    try {
      ...
      if (mode === 'sales_agent' || mode === 'consultation_invite') {
        ...
        userDataContext = buildFullSalesAgentContext(
          agent,
          prospectData,
