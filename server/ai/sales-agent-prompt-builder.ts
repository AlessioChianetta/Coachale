...
export function buildFullSalesAgentContext(
  ...
  // PART 1: Static prompt (rules, scripts, business data)
  const staticPrompt = buildStaticSalesAgentPrompt(agentConfig);
...
export function buildStaticSalesAgentPrompt(agentConfig: SalesAgentConfig): string {
...
`);
  ...
  if (agentConfig.enableDiscovery) {
    sections.push(`
# ═══════════════════════════════════════════════════════════════════════════
# SCRIPT #1: DISCOVERY CALL (FASE INIZIALE)
# ═══════════════════════════════════════════════════════════════════════════
