...
export const LOGICAL_COLUMNS: Record<string, LogicalColumnDefinition> = {
  ...
  cost_foodbev: {
    name: "cost_foodbev",
    displayName: "Production Cost: Food & Beverage",
    displayNameIt: "Costo Produzione: Food & Beverage",
    dataType: "NUMERIC",
    description: "Production cost component for food and beverage raw materials",
    requiredForMetrics: ["cost_foodbev_total", "cost_foodbev_percent", "total_production_cost", "prime_cost"],
  },
  cost_materials: {
    name: "cost_materials",
    displayName: "Production Cost: Materials",
    displayNameIt: "Costo Produzione: Materiali",
    dataType: "NUMERIC",
    description: "Production cost component for materials and supplies",
    requiredForMetrics: ["cost_materials_total", "total_production_cost"],
  },
  cost_extra: {
    name: "cost_extra",
    displayName: "Production Cost: Extra",
    displayNameIt: "Costo Produzione: Extra",
    dataType: "NUMERIC",
    description: "Production cost component for extra/miscellaneous costs",
    requiredForMetrics: ["cost_extra_total", "total_production_cost"],
  },
  cost_staff: {
    name: "cost_staff",
    displayName: "Production Cost: Staff",
    displayNameIt: "Costo Produzione: Personale",
    dataType: "NUMERIC",
    description: "Production cost component for staff/labor",
    requiredForMetrics: ["cost_staff_total", "cost_staff_percent", "total_production_cost", "prime_cost", "prime_cost_percent"],
  },
  cost_structure: {
    name: "cost_structure",
    displayName: "Production Cost: Structure",
    displayNameIt: "Costo Produzione: Struttura",
    dataType: "NUMERIC",
    description: "Production cost component for structure/rent/facilities",
    requiredForMetrics: ["cost_structure_total", "total_production_cost"],
  },
  cost_utilities: {
    name: "cost_utilities",
    displayName: "Production Cost: Utilities",
    displayNameIt: "Costo Produzione: Consumi",
    dataType: "NUMERIC",
    description: "Production cost component for utilities/consumption (energy, water)",
    requiredForMetrics: ["cost_utilities_total", "total_production_cost"],
  },
};
...
export const COLUMN_AUTO_DETECT_PATTERNS: Record<string, RegExp[]> = {
  ...
  cost: [
    ...
    /^food_?cost/i,
    /^costo_?acquisto/i,
    /^costoproduzione_?prezzoacquisto/i,
    /^prezzo_?acquisto/i,
    /^purchase_?price/i,
    /^buy_?price/i,
    /^costo_?materia/i,
