...
import { conversationMemoryService, conversationContextBuilder, ConversationContextBuilder } from "../services/conversation-memory";
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`;
        ...
        // Budget: 8000 tokens max for combined history + daily summaries
        if (req.silverGoldUser?.level === "3" && req.silverGoldUser?.subscriptionId) {
          try {
            ...
            if (historyContext.hasHistory || memoryContext.hasHistory) {
              ...
              if (combinedText) {
                systemPrompt += `\n\n${combinedText}`;
                console.log(`[PUBLIC AGENT] Gold memory injected: ~${totalTokens} tokens${wasTruncated ? ' (truncated to budget)' : ''}`);
              }
            } else {
